...
public class CatUnitTest {
	...
	public void testGetName() {
		// TODO: Fill in
		String returnValue = c.getName();
		assertEquals(0, returnValue.compareTo("Jennyanydots"));
	}
	...
	public void testGetRented() {
		// TODO: Fill in
		boolean returnValue = c.getRented();
	...
	public void testToString() {
		...
		assertEquals(0, returnValue.compareTo("ID 1. Jennyanydots"));
	}
	...
	public void testRenameCat() {
		...
		String r1 = c.getName();
		assertEquals(0, r1.compareTo("Garfield"));
		String r2 = c.toString();
		assertEquals(0, r2.compareTo("ID 1. Garfield"));
	}
